...
usa este proyecto, ver `AGENTS.md`).

No hace falta grabar ningún video — este estilo no usa cámara, todo el
audio se genera.

## Flujo paso a paso (instrucciones para Codex)
...
`content/guiones/mitos-Codex-negocio.json`, guion completo en ese archivo):

```json
{
  "slug": "mitos-Codex-negocio",
  "topic": "4 mitos que te impiden usar Codex en tu negocio",
